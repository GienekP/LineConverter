#############################################################################
# Makefile for building: qtLineConverter.app/Contents/MacOS/qtLineConverter
# Generated by qmake (3.0) (Qt 5.7.0)
# Project:  qtLineConverter.pro
# Template: app
# Command: /Users/grzegorz/Qt/5.7/clang_64/bin/qmake -spec macx-clang CONFIG+=x86_64 -o Makefile qtLineConverter.pro
#############################################################################
...
CFLAGS        = -pipe -O2 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.1.sdk -mmacosx-version-min=10.8 -Wall -W -fPIC $(DEFINES)
CXXFLAGS      = -pipe -stdlib=libc++ -O2 -std=gnu++11 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.1.sdk -mmacosx-version-min=10.8 -Wall -W -fPIC $(DEFINES)
INCPATH       = -I. -I../../Qt/5.7/clang_64/lib/QtWidgets.framework/Headers -I../../Qt/5.7/clang_64/lib/QtGui.framework/Headers -I../../Qt/5.7/clang_64/lib/QtCore.framework/Headers -I. -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.1.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.1.sdk/System/Library/Frameworks/AGL.framework/Headers -I. -I../../Qt/5.7/clang_64/mkspecs/macx-clang -F/Users/grzegorz/Qt/5.7/clang_64/lib
QMAKE         = /Users/grzegorz/Qt/5.7/clang_64/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = qtLineConverter1.0.0
DISTDIR = /Users/grzegorz/QtProjekty/qtLineConverter/.tmp/qtLineConverter1.0.0
LINK          = /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang++
LFLAGS        = -headerpad_max_install_names -stdlib=libc++ -Wl,-syslibroot,/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.1.sdk -mmacosx-version-min=10.8 -Wl,-rpath,/Users/grzegorz/Qt/5.7/clang_64/lib
LIBS          = $(SUBLIBS) -F/Users/grzegorz/Qt/5.7/clang_64/lib -framework QtWidgets -framework QtGui -framework QtCore -framework DiskArbitration -framework IOKit -framework OpenGL -framework AGL 
...
SOURCES       = main.cpp \
		mainwindow.cpp \
		ataripalgen.cpp \
		ataripic.cpp qrc_qtLineConverter.cpp \
		moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		ataripalgen.o \
		ataripic.o \
		qrc_qtLineConverter.o \
		moc_mainwindow.o
DIST          = ../../Qt/5.7/clang_64/mkspecs/features/spec_pre.prf \
		...
		qtLineConverter.pro mainwindow.h \
		ataripalgen.h \
		ataripic.h \
		basexex.h main.cpp \
		mainwindow.cpp \
		ataripalgen.cpp \
		ataripic.cpp
QMAKE_TARGET  = qtLineConverter
DESTDIR       = 
TARGET        = qtLineConverter.app/Contents/MacOS/qtLineConverter
...
$(TARGET): ui_mainwindow.h $(OBJECTS)  
	@test -d qtLineConverter.app/Contents/MacOS/ || mkdir -p qtLineConverter.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: qtLineConverter.pro ../../Qt/5.7/clang_64/mkspecs/macx-clang/qmake.conf ../../Qt/5.7/clang_64/mkspecs/features/spec_pre.prf \
		../../Qt/5.7/clang_64/mkspecs/qdevice.pri \
		../../Qt/5.7/clang_64/mkspecs/features/device_config.prf \
		../../Qt/5.7/clang_64/mkspecs/common/unix.conf \
		../../Qt/5.7/clang_64/mkspecs/common/mac.conf \
	...
	$(QMAKE) -spec macx-clang CONFIG+=x86_64 -o Makefile qtLineConverter.pro
...
qtLineConverter.app/Contents/PkgInfo: 
	@test -d qtLineConverter.app/Contents || mkdir -p qtLineConverter.app/Contents
	@$(DEL_FILE) qtLineConverter.app/Contents/PkgInfo
	@echo "APPL????" > qtLineConverter.app/Contents/PkgInfo
qtLineConverter.app/Contents/Resources/empty.lproj: 
	@test -d qtLineConverter.app/Contents/Resources || mkdir -p qtLineConverter.app/Contents/Resources
	@touch qtLineConverter.app/Contents/Resources/empty.lproj
	
qtLineConverter.app/Contents/Info.plist: 
	@test -d qtLineConverter.app/Contents || mkdir -p qtLineConverter.app/Contents
	@$(DEL_FILE) qtLineConverter.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@BUNDLEIDENTIFIER@,RIOT.qtLineConverter,g" -e "s,@ICON@,qtLineConverter.icns,g" -e "s,@EXECUTABLE@,qtLineConverter,g" -e "s,@LIBRARY@,qtLineConverter,g" -e "s,@TYPEINFO@,????,g" ../../Qt/5.7/clang_64/mkspecs/macx-clang/Info.plist.app >qtLineConverter.app/Contents/Info.plist
qtLineConverter.app/Contents/Resources/qtLineConverter.icns: qtLineConverter.icns
	@test -d qtLineConverter.app/Contents/Resources/ || mkdir -p qtLineConverter.app/Contents/Resources/
	@$(DEL_FILE) qtLineConverter.app/Contents/Resources/qtLineConverter.icns
	@$(COPY_FILE) qtLineConverter.icns qtLineConverter.app/Contents/Resources/qtLineConverter.icns

all: Makefile \
		qtLineConverter.app/Contents/PkgInfo \
		qtLineConverter.app/Contents/Resources/empty.lproj \
		qtLineConverter.app/Contents/Info.plist \
		qtLineConverter.app/Contents/Resources/qtLineConverter.icns $(TARGET)
...
distdir: FORCE
	...
	$(COPY_FILE) --parents qtLineConverter.qrc $(DISTDIR)/
	$(COPY_FILE) --parents mainwindow.h ataripalgen.h ataripic.h basexex.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp mainwindow.cpp ataripalgen.cpp ataripic.cpp $(DISTDIR)/
...
distclean: clean 
	-$(DEL_FILE) -r qtLineConverter.app
...
compiler_rcc_make_all: qrc_qtLineConverter.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_qtLineConverter.cpp
qrc_qtLineConverter.cpp: qtLineConverter.qrc \
		../../Qt/5.7/clang_64/bin/rcc \
		qtLineConverter.png \
		qtLineConverter.icns \
		qtLineConverter.ico
	/Users/grzegorz/Qt/5.7/clang_64/bin/rcc -name qtLineConverter qtLineConverter.qrc -o qrc_qtLineConverter.cpp
...
moc_mainwindow.cpp: ../../Qt/5.7/clang_64/lib/QtWidgets.framework/Headers/QMainWindow \
		...
		../../Qt/5.7/clang_64/lib/QtCore.framework/Headers/QDataStream \
	...
	/Users/grzegorz/Qt/5.7/clang_64/bin/moc $(DEFINES) -D__APPLE__ -D__GNUC__=4 -D__APPLE_CC__ -I/Users/grzegorz/Qt/5.7/clang_64/mkspecs/macx-clang -I/Users/grzegorz/QtProjekty/qtLineConverter -I/Users/grzegorz/Qt/5.7/clang_64/lib/QtWidgets.framework/Headers -I/Users/grzegorz/Qt/5.7/clang_64/lib/QtGui.framework/Headers -I/Users/grzegorz/Qt/5.7/clang_64/lib/QtCore.framework/Headers -I/usr/local/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/13.0.0/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -I'/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/System/Library/Frameworks (framework directory)' -F/Users/grzegorz/Qt/5.7/clang_64/lib mainwindow.h -o moc_mainwindow.cpp
...
ui_mainwindow.h: mainwindow.ui \
	...
	/Users/grzegorz/Qt/5.7/clang_64/bin/uic mainwindow.ui -o ui_mainwindow.h
...
ataripalgen.o: ataripalgen.cpp ataripalgen.h \
		../../Qt/5.7/clang_64/lib/QtGui.framework/Headers/QColor \
		../../Qt/5.7/clang_64/lib/QtGui.framework/Headers/qcolor.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ataripalgen.o ataripalgen.cpp

ataripic.o: ataripic.cpp ataripic.h \
		../../Qt/5.7/clang_64/lib/QtCore.framework/Headers/QTextStream \
		../../Qt/5.7/clang_64/lib/QtCore.framework/Headers/qtextstream.h \
		../../Qt/5.7/clang_64/lib/QtCore.framework/Headers/QDataStream \
		../../Qt/5.7/clang_64/lib/QtCore.framework/Headers/qdatastream.h \
		...
		../../Qt/5.7/clang_64/lib/QtGui.framework/Headers/qcolor.h \
		basexex.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ataripic.o ataripic.cpp

qrc_qtLineConverter.o: qrc_qtLineConverter.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_qtLineConverter.o qrc_qtLineConverter.cpp
